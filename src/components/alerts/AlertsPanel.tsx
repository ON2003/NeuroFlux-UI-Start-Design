      ...
      <AnimatePresence>
        {!isCollapsed && (
          ...
          >
            ...
            <div className="divide-y divide-lab-surface">
              {alerts.map((alert) => (
                <motion.div
                  ...
                  className="px-5 py-2 cursor-pointer transition-all group relative border-l-2 border-transparent hover:border-l-critical/50"
                >
            ...
            {/* Footer Insight */}
            <div className="mt-auto p-4 bg-slate-dark text-white/90 text-xs font-mono">
